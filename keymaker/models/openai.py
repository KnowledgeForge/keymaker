...
class OpenAIChat(ChatModel):
    ...
    async def _generate(
        ...
        async with aiohttp.ClientSession() as session:
            ...
            completion_stream = await openai.ChatCompletion.acreate(**self.addtl_create_kwargs, **payload, stream=True)
...
class OpenAICompletion(Model):
    ...
    async def _generate(
        ...
        async with aiohttp.ClientSession() as session:
            openai.aiosession.set(session)
            completion_stream = await openai.Completion.acreate(**self.addtl_create_kwargs, **payload, stream=True)
